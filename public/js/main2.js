/******/ (() => {
    ...
    const css_tag_t = window,
        css_tag_e =
            ...
            (void 0 === css_tag_t.ShadyCSS ||
                css_tag_t.ShadyCSS.nativeShadow) &&
    ...
    (u[d] = !0),
        ...
        null == reactive_element_o ||
            reactive_element_o({ ReactiveElement: u }),
        (null !==
            (reactive_element_s = reactive_element_e.reactiveElementVersions) &&
        void 0 !== reactive_element_s
            ? reactive_element_s
            : (reactive_element_e.reactiveElementVersions = [])
        ).push("1.6.3"); // CONCATENATED MODULE: ./node_modules/lit-html/lit-html.js
    ...
    const lit_html_i = window,
        ...
        m = />/g,
        p = RegExp(
            `>|${lit_html_a}(?:([^\\s"'>=/]+)(${lit_html_a}*=${lit_html_a}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,
            "g"
        ),
        g = /'/g,
        $ = /"/g,
    ...
    const V = (t, i) => {
        ...
        for (let i = 0; i < s; i++) {
            ...
            for (
                ;
                a < s.length &&
                ((u.lastIndex = a), (c = u.exec(s)), null !== c);
            ...
            r +=
                u === f
                    ...
                    : v >= 0
                    ? (e.push(d),
                      s.slice(0, v) + lit_html_o + s.slice(v) + lit_html_n + w)
                    : s + lit_html_n + (-2 === v ? (e.push(void 0), i) : w);
        }
                ...
                if (1 === h.nodeType) {
                    if (h.hasAttributes()) {
                        ...
                        for (const i of h.getAttributeNames())
                            if (
                                i.endsWith(lit_html_o) ||
                                i.startsWith(lit_html_n)
                            ) {
                                const s = f[d++];
                                if ((t.push(i), void 0 !== s)) {
                                    const t = h
                                            .getAttribute(
                                                s.toLowerCase() + lit_html_o
                                            )
                                            .split(lit_html_n),
                                        i = /([.?@])?(.*)/.exec(s);
                                    v.push({
                    ...
                    if (y.test(h.tagName)) {
                        const t = h.textContent.split(lit_html_n),
                            i = t.length - 1;
                        if (i > 0) {
                            h.textContent = lit_html_s
                                ? lit_html_s.emptyScript
                                : "";
                            for (let s = 0; s < i; s++)
                                h.append(t[s], lit_html_u()),
                                    C.nextNode(),
                    ...
                    if (h.data === lit_html_l) v.push({ type: 2, index: r });
                    else {
                        let t = -1;
                        for (; -1 !== (t = h.data.indexOf(lit_html_n, t + 1)); )
                            v.push({ type: 7, index: r }),
            ...
            (null == r ? void 0 : r.constructor) !== u &&
                ...
                void 0 !== e
                    ? ((null !== (l = (h = s)._$Co) && void 0 !== l
                          ...
                          : (h._$Co = []))[e] = r)
                    : (s._$Cl = r)),
            void 0 !== r && (i = lit_html_S(t, r._$AS(t, i.values), r, e)),
            i
        );
    }
    class M {
    ...
    class R {
        ...
        _(t) {
            this._$AH !== A && lit_html_d(this._$AH)
                ? (this._$AA.nextSibling.data = t)
                : this.$(lit_html_r.createTextNode(t)),
                (this._$AH = t);
        }
        g(t) {
            var i;
            const { values: s, _$litType$: e } = t,
                o =
                    "number" == typeof e
                        ? this._$AC(t)
                        : (void 0 === e.el &&
                              (e.el = N.createElement(
                                  P(e.h, e.h[0]),
                                  this.options
                              )),
                          e);
            if (
                (null === (i = this._$AH) || void 0 === i ? void 0 : i._$AD) ===
                o
            )
                this._$AH.v(s);
            else {
        ...
        _$AI(t, i = this, s, e) {
            ...
            if (void 0 === o)
                (t = lit_html_S(this, t, i, 0)),
                    (n = !lit_html_d(t) || (t !== this._$AH && t !== T)),
                    n && (this._$AH = t);
            else {
                const e = t;
                let l, h;
                for (t = o[0], l = 0; l < o.length - 1; l++)
                    (h = lit_html_S(this, e[s + l], i, l)),
                        h === T && (h = this._$AH[l]),
                        n || (n = !lit_html_d(h) || h !== this._$AH[l]),
                        h === A
                            ? (t = A)
                            : t !== A && (t += (null != h ? h : "") + o[l + 1]),
                        (this._$AH[l] = h);
            }
            n && !e && this.j(t);
        }
    ...
    class z extends k {
        ...
        _$AI(t, i = this) {
            ...
            if (
                (t =
                    null !== (s = lit_html_S(this, t, i, 0)) && void 0 !== s
                        ? s
                        : A) === T
            )
                return;
    ...
    ).push("3.3.3"); // CONCATENATED MODULE: ./node_modules/lit/index.js // CONCATENATED MODULE: ./src/js/components/base/LitWithoutShadowDom.js
    //# sourceMappingURL=lit-element.js.map

    //# sourceMappingURL=index.js.map

    class LitWithoutShadowDom extends lit_element_s {
        createRenderRoot() {
            return this;
        }
    }

    /* harmony default export */ const base_LitWithoutShadowDom =
        LitWithoutShadowDom; // CONCATENATED MODULE: ./src/js/components/_BookCard.js

    class BookCard extends base_LitWithoutShadowDom {
        static properties = {
            bookId: {
                type: String,
                reflect: true,
        ...
        render() {
            ...
            if (this.bookFavorite) {
                favoriteButtonIcon = x`<i class="bi bi-star-fill"></i>`;
            } else {
                favoriteButtonIcon = x`<i class="bi bi-star"></i>`;
            }
    ...
    customElements.define("book-card", BookCard); // CONCATENATED MODULE: ./src/js/components/_AsideCanvas.js

    class AsideCanvas extends base_LitWithoutShadowDom {
        static properties = {
            id: {
                type: String,
                reflect: true,
    ...
    customElements.define("aside-canvas", AsideCanvas); // CONCATENATED MODULE: ./node_modules/axios/lib/helpers/bind.js
    ...
    function buildURL(url, params, options) {
        ...
        if (serializeFn) {
            ...
            serializedParams = utils.isURLSearchParams(params)
                ? params.toString()
                : new helpers_AxiosURLSearchParams(params, options).toString(
                      _encode
                  );
        }
    ...
    /* harmony default export */ const classes_FormData =
        typeof FormData !== "undefined" ? FormData : null; // CONCATENATED MODULE: ./node_modules/axios/lib/platform/browser/classes/Blob.js

    /* harmony default export */ const classes_Blob =
        typeof Blob !== "undefined" ? Blob : null; // CONCATENATED MODULE: ./node_modules/axios/lib/platform/browser/index.js
        ...
        function (config) {
            return new Promise(function dispatchXhrRequest(resolve, reject) {
                ...
                if (utils.isFormData(requestData)) {
                    if (
                        browser.isStandardBrowserEnv ||
                        browser.isStandardBrowserWebWorkerEnv
                    ) {
                ...
                request.ontimeout = function handleTimeout() {
                    let timeoutErrorMessage = config.timeout
                        ...
                        : "timeout exceeded";
                    const transitional =
                        config.transitional || defaults_transitional;
    ...
    /* harmony default export */ const lib_axios = axios; // CONCATENATED MODULE: ./src/js/components/_SearchForm.js

    class SearchForm extends base_LitWithoutShadowDom {
        static properties = {
            searchFrom: {
                type: String,
                reflect: true,
    ...
    customElements.define("search-form", SearchForm); // CONCATENATED MODULE: ./src/js/components/_ProfileCard.js

    class ProfileCard extends base_LitWithoutShadowDom {
        _profileTabChange = (e) => {
    ...
    customElements.define("profile-card", ProfileCard); // CONCATENATED MODULE: ./src/js/components/index.js // CONCATENATED MODULE: ./node_modules/@popperjs/core/lib/enums.js
    ...
    function getDocumentRect(element) {
        ...
        if (
            getComputedStyle_getComputedStyle(body || html).direction === "rtl"
        ) {
            x +=
...
*/
    ...
    class Config {
        ...
        _mergeConfigObj(config, element) {
            const jsonConfig = bootstrap_esm_isElement(element)
        ...
        _typeCheckConfig(config, configTypes = this.constructor.DefaultType) {
            for (const [property, expectedTypes] of Object.entries(
                ...
                const valueType = bootstrap_esm_isElement(value)
                    ? "element"
                    : toType(value);
    ...
    const bootstrap_esm_VERSION = "5.3.1";
    ...
    defineJQueryPlugin(Toast); // CONCATENATED MODULE: ./src/js/pages/UserIndex.js
    ...
    /* harmony default export */ const pages_UserIndex = UserIndex; // CONCATENATED MODULE: ./src/js/pages/UserProfile.js
    ...
    /* harmony default export */ const pages_UserProfile = UserProfile; // CONCATENATED MODULE: ./src/js/index.js
    ...
    const scriptSources = {
        userIndex: pages_UserIndex,
        userProfile: pages_UserProfile,
    };
