            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control custom-form-control @error('book_code') is-invalid @enderror" name="book_code" id="book_code" required value="{{ old('book_code', $book->book_code) }}" />
                        @error('book_code')
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" class="form-control custom-form-control @error('publication_year') is-invalid @enderror" name="publication_year" id="publication_year" required  value="{{ old('publication_year', $book->publication_year) }}"/>
